...
function SimulationRenderer(WIDTH, renderer) {
    ...
    var passThruShader = new THREE.ShaderMaterial({
        uniforms: uniforms,
        vertexShader: shaders.vertexShaders.pass, //document.getElementById( 'vertexShader' ).textContent,
        fragmentShader: shaders.fragmentShaders.pass, //document.getElementById( 'fragmentShader' ).textContent
    });
    ...
    var positionShader = new THREE.ShaderMaterial({
        ...
        vertexShader: shaders.vertexShaders.pass, //document.getElementById( 'vertexShader' ).textContent,
        fragmentShader: shaders.fragmentShaders.pos //document.getElementById( 'fragmentShaderPosition' ).textContent
    ...
    var velocityShader = new THREE.ShaderMaterial({
        ...
        vertexShader: shaders.vertexShaders.pass, //document.getElementById( 'vertexShader' ).textContent,
        fragmentShader: shaders.fragmentShaders.vel //document.getElementById( 'fragmentShaderVelocity' ).textContent
