...
shaders.load( 'birds-vs' , 'text' , 'vertex'   );
shaders.load( 'birds-fs' , 'text' , 'fragment' );
shaders.load( 'pass-vs' , 'pass' , 'vertex'   );
shaders.load( 'pass-fs' , 'pass' , 'fragment' );
shaders.load( 'position-fs' , 'pos' , 'fragment'   );
shaders.load( 'velocity-fs' , 'vel' , 'fragment' );
...
function init() {
    ...
    gui.add(effectController, "freedom", 0.0, 1.00, 0.001).onChange(valuesChanger);
    gui.close();
...
function initBirds() {
    ...
    console.log(shaders.vertexShaders.text),
    console.log(shaders.fragmentShaders.text);
